...
class Positiebepaling:
    #construction of the object:
    def updateAfstandmuur(self):
        pass
    def updateHoekMuur(self):
        pass
    def updateHoogte(self):
        self.Hoogte = drone.navdata.demo.altitude/1000
		
    def updateZijwaards(self):
...
#            cv2.circle(framecon, (320,180), 3, (255,255,0))
            ...
            self.Zijwaards = afwijkingX_mm
            self.Voorwaards = afwijkingY_mm
        except:
            self.Zijwaards = 0
    ...
    def updateAll(self):
        self.updateAfstandmuur()
        self.updateHoekMuur()
        self.updateHoogte()
        self.updateZijwaards()
